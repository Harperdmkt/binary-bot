...
Blockly.Blocks.direction = {
  init: function init() {
    ...
    this.setTooltip(translator.translateText("Returns the tick direction received by a before purchase block, its value could be 'up' if the tick is more than before, 'down' if less than before and empty ('') if the tick is equal to the previous tick"))
